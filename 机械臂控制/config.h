...
#define INITIAL_Z -140.0 // CARTESIAN COORDINATE Z

#define INITIAL_E0 0.0 // RAIL STEPPER ENDSTOP POSITION 

//  CALIBRATE HOME STEPS TO REACH DESIRED INITIAL_XYZ POSITIONS
#define X_HOME_STEPS 0 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 0 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
...
//GEAR RATIO SETTINGS
#define MOTOR_GEAR_TEETH 1.0    // 20.0  GEAR 
#define MAIN_GEAR_TEETH  4.5    // 90.0  GEAR
